---
page_id: component-component:Cargo.toml
page_type: component
generation_mode: inferred
freshness_status: new
updated_at: 2026-04-12T23:17:54.630Z
---
...
```json
{
  "freshnessKey": "b52ad2f5faf80319856218dfcef6e83c4bbcfa65",
...
monarchic-agent-protocol rust component
...
Impacted areas:
- Downstream components likely affected: `name`, `path`, `prost`, `prost-build`.
