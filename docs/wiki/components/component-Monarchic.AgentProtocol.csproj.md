---
page_id: component-component:Monarchic.AgentProtocol.csproj
page_type: component
generation_mode: inferred
freshness_status: new
updated_at: 2026-04-12T23:17:54.654Z
---
...
```json
{
  "freshnessKey": "99c2120449934ad39411ccc25935ae99c16d3536",
  ...
  "changedPaths": [
    ...
    "src/dart/lib/monarchic_agent_protocol.pbenum.dart",
    "src/dart/lib/monarchic_agent_protocol.pbjson.dart",
...
monarchic-agent-protocol dotnet component
...
- Run `gradle test` (test) from `.`.
- Run `nix build .#default` (build) from `.`.
- Run `nix flake check` (check) from `.`.
...
Impacted areas:
- Downstream components likely affected: `Google.Protobuf`.
