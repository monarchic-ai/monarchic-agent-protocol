...
script_label="test-project-state-artifact-command-log-wrapper-ownership"

source "${repo_root}/scripts/project-state-command-log-test-lib.sh"

artifact_helper_prefix='project_state'"_artifact_"
...
wrapper_helper_prefix="project_state_command_log_"
wrapper_lib_reference="project-state-command-log-test-lib.sh"
wrapper_lib_path="${repo_root}/scripts/${wrapper_lib_reference}"
wrapper_core_paths_helper="project_state_command_log_core_paths"
wrapper_core_path_membership_helper="project_state_command_log_assert_core_path_listed"
wrapper_first_core_path_helper="project_state_command_log_first_core_path"
wrapper_first_core_path_in_root_helper="project_state_command_log_first_core_path_in_root"
wrapper_first_core_path_in_tmp_root_helper="project_state_command_log_first_core_path_in_tmp_root"
wrapper_first_core_path_pair_in_root_helper="project_state_command_log_first_core_path_pair_in_root"
wrapper_first_core_path_pair_in_tmp_root_helper="project_state_command_log_first_core_path_pair_in_tmp_root"
wrapper_assign_first_core_path_pair_in_root_helper="project_state_command_log_assign_first_core_path_pair_in_root"
wrapper_assign_first_core_path_pair_in_tmp_root_helper="project_state_command_log_assign_first_core_path_pair_in_tmp_root"
wrapper_assign_existing_first_core_path_pair_in_root_helper="project_state_command_log_assign_existing_first_core_path_pair_in_root"
wrapper_assign_existing_first_core_path_pair_in_tmp_root_helper="project_state_command_log_assign_existing_first_core_path_pair_in_tmp_root"
wrapper_remove_existing_first_core_path_pair_in_root_helper="project_state_command_log_remove_existing_first_core_path_pair_in_root"
wrapper_remove_existing_first_core_path_pair_in_tmp_root_helper="project_state_command_log_remove_existing_first_core_path_pair_in_tmp_root"
wrapper_seed_helper="project_state_command_log_seed_source_repo_with_empty_report_lists"
wrapper_seeded_core_paths_helper="project_state_command_log_assert_seeded_source_repo_core_paths"
wrapper_prepare_seeded_source_repo_helper="project_state_command_log_prepare_seeded_source_repo"
wrapper_seeded_baseline_helper="project_state_command_log_prepare_seeded_source_repo_baseline"
wrapper_setup_helper="project_state_command_log_setup"
wrapper_report_paths_helper="project_state_command_log_report_paths"
wrapper_report_relative_path_helper="project_state_command_log_report_relative_path"
wrapper_report_path_in_root_helper="project_state_command_log_report_path_in_root"
wrapper_report_json_mutation_in_root_helper="project_state_command_log_mutate_report_json_in_root"
wrapper_empty_report_paths_in_root_helper="project_state_command_log_assert_report_paths_empty_in_root"
wrapper_empty_report_paths_helper="project_state_command_log_assert_report_paths_empty"
wrapper_fixture_paths_helper="project_state_command_log_fixture_paths"
wrapper_copy_relative_path_helper="project_state_command_log_copy_relative_path"
wrapper_reset_fixtures_helper="project_state_command_log_reset_fixtures"
wrapper_tmp_root_helper="project_state_command_log_tmp_root"
wrapper_root_path_helper="project_state_command_log_path_in_root"
wrapper_tmp_path_helper="project_state_command_log_tmp_path_for_relative_path"
wrapper_command_log_tmp_path_helper="project_state_command_log_tmp_path"
wrapper_reset_baseline_helper="project_state_command_log_reset_and_assert_baseline"
wrapper_reset_tmp_path_helper="project_state_command_log_reset_and_resolve_tmp_path"
wrapper_reason_code_helper="project_state_command_log_expect_reason_code"
wrapper_reason_code_after_mutation_helper="project_state_command_log_expect_reason_code_after_mutation"
wrapper_stderr_contains_after_mutation_helper="project_state_command_log_expect_stderr_contains_after_mutation"
wrapper_status_and_index_reason_codes_helper="project_state_command_log_expect_status_and_index_reason_codes"
wrapper_stderr_contains_helper="project_state_command_log_expect_stderr_contains"
wrapper_failure_contains_helper="project_state_command_log_expect_failure_contains"
wrapper_choose_python_helper="project_state_command_log_choose_python"
wrapper_python_cmd_helper="project_state_command_log_python_cmd"
wrapper_json_file_mutation_helper="project_state_command_log_mutate_json_file"
wrapper_json_mutation_helper="project_state_command_log_mutate_json"
disallowed_state_prefix="PROJECT_COMMAND_LOG_"
...
shopt -s nullglob
command_log_scripts=("${repo_root}"/scripts/test-project-state-artifact-command-log-*.sh)
shopt -u nullglob
...
first_core_path_in_tmp_root_body="$(wrapper_helper_body "${wrapper_first_core_path_in_tmp_root_helper}")"
if [[ -z "${first_core_path_in_tmp_root_body}" ]]; then
  echo "[${script_label}] Expected ${wrapper_lib_reference} to define ${wrapper_first_core_path_in_tmp_root_helper}." >&2
  exit 1
fi

if [[ "${first_core_path_in_tmp_root_body}" != *"${wrapper_tmp_root_helper}"* ]]; then
  echo "[${script_label}] Expected ${wrapper_first_core_path_in_tmp_root_helper} to resolve the wrapper-owned temp root through ${wrapper_tmp_root_helper} so temp-root state reads stay centralized." >&2
  exit 1
fi

if [[ "${first_core_path_in_tmp_root_body}" != *"${wrapper_first_core_path_in_root_helper}"* ]]; then
  echo "[${script_label}] Expected ${wrapper_first_core_path_in_tmp_root_helper} to delegate rooted temp first-core-path resolution through ${wrapper_first_core_path_in_root_helper}." >&2
  exit 1
fi
...
for script_path in "${command_log_scripts[@]}"; do
  ...
  if grep -Eq '\bPROJECT_COMMAND_LOG_(TMP_REPO|STDERR_LOG|PYTHON_CMD)\b' "${script_path}"; then
  ...
  if grep -Eq '\bproject_state_command_log_core_paths\b[[:space:]]*\|[[:space:]]*grep -[A-Za-z]*q' "${script_path}"; then
  ...
  if awk '
    /project_state_command_log_reset_fixtures/ { saw_reset=1; next }
    saw_reset && /^[[:space:]]*$/ { next }
    saw_reset && /project_state_command_log_assert_baseline_passes/ { exit 0 }
  ...
  case "${script_name}" in
    test-project-state-artifact-command-log-first-command.sh|test-project-state-artifact-command-log-format.sh)
  ...
  case "${script_name}" in
    test-project-state-artifact-command-log-gate.sh|test-project-state-artifact-command-log-reason-codes.sh)
  ...
  case "${script_name}" in
    test-project-state-artifact-command-log-reason-codes.sh)
      ...
      ;;
    test-project-state-artifact-command-log-gate.sh)
      if ! grep -Fq "${wrapper_reason_code_after_mutation_helper}" "${script_path}"; then
  ...
  case "${script_name}" in
    test-project-state-artifact-command-log-first-command.sh|test-project-state-artifact-command-log-format.sh)
      if grep -Eq '\bproject_state_command_log_run_check\b|grep -[A-Za-z]*q .*stderr_log_path|cat \"?\$\{stderr_log_path\}\"?' "${script_path}"; then
  ...
  case "${script_name}" in
    test-project-state-artifact-command-log-path-helper.sh)
      ...
      ;&
    test-project-state-artifact-command-log-source-repo-seeding.sh)
      ...
      if grep -Eq 'validation_output=.*\bproject_state_command_log_assert_' "${script_path}"; then
  ...
  case "${script_name}" in
    test-project-state-artifact-command-log-path-helper.sh)
      ...
      ;;
    test-project-state-artifact-command-log-source-repo-seeding.sh|test-project-state-artifact-command-log-shared-fixtures.sh)
      if grep -Eq '\$\{(source_repo|tmp_repo_root)\}/\$\{[^}]+\}' "${script_path}"; then
  ...
  case "${script_name}" in
    test-project-state-artifact-command-log-path-helper.sh)
      if ! grep -Fq "${wrapper_first_core_path_in_tmp_root_helper}" "${script_path}"; then
        echo "[${script_label}] Expected ${script_name} to use ${wrapper_first_core_path_in_tmp_root_helper} so temp-root first-core-path resolution stays centralized." >&2
        exit 1
      fi
      ...
      if grep -Fq "${wrapper_tmp_path_helper} \"\${first_core_relative_path}\"" "${script_path}"; then
        echo "[${script_label}] Expected ${script_name} to resolve temp-root first core paths through ${wrapper_first_core_path_in_tmp_root_helper} instead of composing ${wrapper_first_core_path_helper} with ${wrapper_tmp_path_helper} inline." >&2
        exit 1
      fi
  ...
  case "${script_name}" in
    test-project-state-artifact-command-log-path-helper.sh|test-project-state-artifact-command-log-shared-fixtures.sh)
  ...
  case "${script_name}" in
    test-project-state-artifact-command-log-path-helper.sh)
      ...
      ;;
    test-project-state-artifact-command-log-shared-fixtures.sh)
