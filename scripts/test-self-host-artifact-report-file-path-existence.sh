...
script_label="test-self-host-artifact-report-file-path-existence"
...
if ! grep -q "changed_files reference missing file path(s)" "${SELF_HOST_ARTIFACT_STDERR_LOG}"; then
