...
script_label="test-project-state-artifact-log-key-order"
...
if ! grep -q "Latest implementation log entry must use keys in this order" "${PROJECT_STATE_ARTIFACT_STDERR_LOG}"; then
